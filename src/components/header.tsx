...
export function Header() {
	return (
		<header className="fixed bottom-8 z-50 flex w-[calc(100vw-32px)] max-w-limit justify-between rounded-xl border border-primary-border bg-white/60 p-4 text-light-gray backdrop-blur-xs sm:top-6 sm:bottom-[unset] sm:mb-32 sm:bg-white/30 dark:bg-onyx/60 dark:sm:bg-onyx/30">
